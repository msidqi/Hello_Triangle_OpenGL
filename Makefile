...
SRC_FILES = main.c glad.c setup.c buffers.c events.c fps_counter.c texture_loader.c \
			ft_model_world_view.c shaders/shader.c shaders/init_shader.c \
			textures/texture_helper.c textures/texture_construct.c
SRC_PATH = src
OBJ_PATH = .obj
